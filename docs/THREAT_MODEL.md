# horizon-atlas: STRIDE Threat Model & Security Posture

Operational security assessment for **Cinematic Planetary Intelligence Lab for Designing Possible Futures**.
