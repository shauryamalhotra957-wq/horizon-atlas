# horizon-atlas: Architecture & System Topology

**Domain**: Cinematic Planetary Intelligence Lab for Designing Possible Futures  
**System Mission**: Interactive climate and socio-ecological planetary simulation suite modeling macroeconomic tipping points, geopolitical trade disruptions, and sustainable transition paths.
...
sequenceDiagram
    ...
    participant Engine as horizon-atlas Core
